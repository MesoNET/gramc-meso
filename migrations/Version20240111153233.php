 ...
 */
final class Version20240111153233 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE adresseip CHANGE adresse adresse TINYTEXT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dac ADD CONSTRAINT FK_18C2D0EA61817AB3 FOREIGN KEY (id_version) REFERENCES version (id_version) ON UPDATE NO ACTION ON DELETE NO ACTION');
