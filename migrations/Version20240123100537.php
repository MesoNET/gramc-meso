 ...
 */
final class Version20240123100537 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE laboratoire CHANGE acro_labo acro_labo VARCHAR(100) NOT NULL, CHANGE nom_labo nom_labo VARCHAR(100) NOT NULL');
